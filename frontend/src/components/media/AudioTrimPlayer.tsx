...
export function AudioTrimPlayer({ src, onRangeChange }: AudioTrimPlayerProps) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- onRangeChange solo reenvia a setState, estable en la practica
  }, [src])
